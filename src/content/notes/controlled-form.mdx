...
<FurtherReading links={[{label:"React: input",href:"https://react.dev/reference/react-dom/components/input"},{label:"React: select",href:"https://react.dev/reference/react-dom/components/select"},{label:"React: textarea",href:"https://react.dev/reference/react-dom/components/textarea"}]} />