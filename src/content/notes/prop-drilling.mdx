# 属性逐层透传：Props、Composition 与 Context
...
<FurtherReading items={[{ label: "React: Passing Data Deeply with Context", href: "https://react.dev/learn/passing-data-deeply-with-context" }, { label: "React: Passing Props to a Component", href: "https://react.dev/learn/passing-props-to-a-component" }]} />