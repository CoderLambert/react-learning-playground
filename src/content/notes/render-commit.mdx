...
<FurtherReading items={[{ label: "React: Render and Commit", href: "https://react.dev/learn/render-and-commit" }, { label: "React: Keeping Components Pure", href: "https://react.dev/learn/keeping-components-pure" }]} />