# Error Boundary + React 19 use：把 pending 与 failure 分到不同边界
...
<FurtherReading links={[{label:"React: use",href:"https://react.dev/reference/react/use"},{label:"React: Suspense",href:"https://react.dev/reference/react/Suspense"},{label:"React: Component Error Boundaries",href:"https://react.dev/reference/react/Component#catching-rendering-errors-with-an-error-boundary"}]} />