...
<Compare
  ...
  left={<ul><li>根据 props/state 计算 fullName</li><li>过滤/排序列表</li><li>点击后发请求或提交</li><li>用 key 重置子树</li></ul>}
  right={<ul><li>订阅浏览器/第三方 API</li><li>连接 WebSocket</li><li>控制非 React widget</li><li>同步定时器或事件监听</li></ul>}
/>
