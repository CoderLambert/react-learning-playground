...
<FurtherReading items={[{label:"React: Profiler",href:"https://react.dev/reference/react/Profiler"},{label:"React DevTools Profiler",href:"https://react.dev/learn/react-developer-tools"}]} />