...
<FurtherReading items={[{label:"React: Render and Commit",href:"https://react.dev/learn/render-and-commit"},{label:"React: React Developer Tools Profiler",href:"https://react.dev/reference/react/Profiler"}]} />