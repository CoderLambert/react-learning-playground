...
<FurtherReading items={[{ label: "React: Sharing State Between Components", href: "https://react.dev/learn/sharing-state-between-components" }, { label: "React: input", href: "https://react.dev/reference/react-dom/components/input" }]} />