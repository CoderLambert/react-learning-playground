...
const SUPPORTED_LANGUAGES = new Set(["jsx", "javascript", "typescript", "tsx", "css", "json", "bash", "diff"]);
const LANGUAGE_ALIASES = Object.freeze({ js: "javascript", ts: "typescript", sh: "bash", shell: "bash", patch: "diff" });
