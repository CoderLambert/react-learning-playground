...
`,(0,n.jsx)(r.h3,{id:`guided-prediction先画出-reveal-顺序`,children:`Guided Prediction：先画出 reveal 顺序`}),`
`,(0,n.jsxs)(r.p,{children:[`在切换任何模式前，选定一个“外层资源先就绪、内层资源更慢”的延迟组合，并写下两条预测：`,(0,n.jsx)(r.strong,{children:`单一 Boundary 会先看到什么？嵌套 Boundary 又会先看到什么？`}),` 预测必须包含 fallback 与最终内容的出现顺序，而不只是说“嵌套更快”。`]}),`
`,(0,n.jsx)(r.p,{children:`写完后再运行 Demo，对照实际 reveal sequence。`}),`
`,(0,n.jsxs)(`details`,{children:[(0,n.jsx)(`summary`,{children:`验证后再展开：检查你的 reveal 模型`}),(0,n.jsx)(r.p,{children:`单一 Boundary 把等待范围绑定在一起，慢子项仍可能让整个边界保持 fallback；嵌套 Boundary 则允许外层已准备内容先 reveal，同时让更慢区域继续显示自己的局部 fallback。差异来自边界结构，而不是 Suspense 把数据请求“加速”了。`}),(0,n.jsx)(r.p,{children:`**Decision boundary：**按照产品允许一起出现/独立等待的 UI 单元设计 Boundary，而不是按组件数量机械拆分。`})]}),`
