...
`,(0,n.jsx)(c,{title:`观察首次与再次打开`,children:(0,n.jsx)(r.p,{children:`运行中间 Demo 首次打开 LazyLessonPanel，记录 fallback；关闭再打开，观察模块通常已缓存，不再经历相同的首次代码加载过程。`})}),`
...
`,(0,n.jsxs)(d,{children:[(0,n.jsx)(r.code,{children:`lazy`}),` 应在模块顶层声明。若在组件 render 内创建新的 lazy component identity，可能导致重复初始化和 State 重置。`]}),`
`,(0,n.jsx)(i,{title:`把所有页面包进一个巨大 fallback`,children:`过大的 Suspense boundary 会让局部资源等待时隐藏过多已可用 UI。边界应匹配产品希望一起 reveal 的视觉单元。`}),`
`,(0,n.jsx)(o,{children:`Suspense 能协调支持 Suspense 的资源；普通 Effect 中发起的 fetch 不会因为外面套了 Suspense 就自动被追踪。`}),`
`,(0,n.jsx)(f,{children:(0,n.jsxs)(r.ul,{children:[`
`,(0,n.jsx)(r.li,{children:`lazy 延迟模块加载。`}),`
`,(0,n.jsx)(r.li,{children:`Suspense 提供等待 UI。`}),`
`,(0,n.jsx)(r.li,{children:`首次加载后模块会缓存。`}),`
