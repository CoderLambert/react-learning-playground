...
`,(0,n.jsx)(i,{title:`测试内部 state 或实现调用次数`,children:(0,n.jsx)(r.p,{children:`除非调用协议本身就是公共契约，否则测试内部 hook/state、私有函数或脆弱 DOM 层级会让安全重构变得困难。优先断言用户能看到/操作的结果。`})}),`
