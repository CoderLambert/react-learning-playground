...
<Summary items={["use 读取 Promise 可触发 Suspense", "rejection 交给 Error Boundary", "资源 identity 必须稳定", "框架/缓存层负责生产级数据协议"]} />

<FurtherReading links={[{label:"React: use",href:"https://react.dev/reference/react/use"},{label:"React: Suspense",href:"https://react.dev/reference/react/Suspense"},{label:"React: Component Error Boundaries",href:"https://react.dev/reference/react/Component#catching-rendering-errors-with-an-error-boundary"}]} />`;export{e as default};