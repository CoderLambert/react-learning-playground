...
test("official docs use the center workspace, switch references, and fullscreen the document", async ({ page }) => {
  await loadApp(page);
...
test("ecosystem lessons open the owning project's official docs in the same workspace", async ({ page }) => {
  await loadApp(page);
